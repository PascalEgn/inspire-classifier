...
def split_and_save_data_for_training(dataframe_path, dest_dir, val_fraction=0.1):
    ...
    Args:
        dataframe_path: The path to the pandas dataframe containing the records.
                        The dataframe should have one column containing the title
                        and abstract text appended (title + abstract). The second
                        column should contain the label as an integer
